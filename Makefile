...
migrateup:
	migrate --path db/migrations --database "mysql://root:mypassword@tcp(127.0.0.1:3306)/sosprojectdb" --verbose up

migratedown:
	migrate --path db/migrations --database "mysql://root:mypassword@tcp(127.0.0.1:3306)/sosprojectdb" --verbose down
